...
@Composable
fun EditLoaiMonAnScreen(viewModel: LoaiMonAnViewModel, navController: NavController) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
        ...
        content = { innerPadding ->
            Column(
                ...
                showEditLoaiMonAn(viewModel, navController)
            }
        }
    )
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun showEditLoaiMonAn(viewModel: LoaiMonAnViewModel, navController: NavController) {
...
//                    navController.navigate("${ROUTE_NAME_SCREEN.Detail.name}/${ Uri.encode((it.uid.toString()))}/${Uri.encode(it.hoten)}/${Uri.encode(it.mssv)}/${Uri.encode(it.diemTB.toString())}/${Uri.encode(it.daratruong.toString())}")
                    ...
                    Row(
                        ...
                        Image(painter = painterResource(id = R.drawable.editimages),
                            contentDescription = "",
                            modifier = Modifier
                                .size(20.dp)
                                .clickable {
                    ...
                    AlertDialog(
                        ...
                        confirmButton = {
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        val newStudent = LoaiMonAn(inputidLoai!!.toInt(), inputTenloai)
